<?php
    // is user is logged in, he shouldn't be able to visit login page anymore
...
<html>
  ...
  <body style="background: #ccc;">
    ...
    <div class="form">
      ...
      <form class="login-form" id="form-lg" action = "<?= "logIn/loginUser/" ?>" method = "post" content="">
        <input type="text" placeholder="email" name="email"/>
        <input type="password" placeholder="password" name="password"/>
        <button tyoe="submit">login</button>
        <p class="message">Not registered? <a href="../../../shelter/public/register" id="form-lg-toggle">Create an account</a></p>
      </form>
    </div>
  </body>
</html>